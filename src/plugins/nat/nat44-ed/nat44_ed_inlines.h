...
always_inline void
init_ed_k (clib_bihash_kv_16_8_t *kv, ip4_address_t l_addr, u16 l_port, ip4_address_t r_addr,
...
always_inline void
init_ed_kv (clib_bihash_kv_16_8_t *kv, ip4_address_t l_addr, u16 l_port, ip4_address_t r_addr,
...
always_inline void
nat44_ed_sm_init_i2o_kv (clib_bihash_kv_16_8_t *kv, ip4_address_t addr, u16 port,
			 u32 fib_index, u8 proto, u32 sm_index)
{
  return init_ed_kv (kv, addr, port, (ip4_address_t)0U, 0, fib_index, proto, 0, sm_index);
}

always_inline void
nat44_ed_sm_init_o2i_kv (clib_bihash_kv_16_8_t *kv, ip4_address_t e_addr, u16 e_port,
			 u32 fib_index, u8 proto, u32 sm_index)
{
  return init_ed_kv (kv, (ip4_address_t)0U, 0, e_addr, e_port, fib_index, proto, 0, sm_index);
}

always_inline void
nat44_ed_sm_init_i2o_k (clib_bihash_kv_16_8_t *kv, ip4_address_t addr, u16 port,
...
always_inline void
nat44_ed_sm_init_o2i_k (clib_bihash_kv_16_8_t *kv, ip4_address_t e_addr, u16 e_port,
			u32 fib_index, u8 proto)
{
